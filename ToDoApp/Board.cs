...
namespace ToDoApp
{
    public class Board
    {
        ...
        public Board()
        {
            kisiler.Add(0, "Seher Elbasan");
            kisiler.Add(1, "İpek Tunç");
            kisiler.Add(2, "Erhan Büyük");
            kisiler.Add(3, "Mert Tuna");
            kisiler.Add(4, "Dilan Söz");

            TODO.Add(new Kart("Temizlik", "Yerleri Supur", "Seher Elbasan",Kart.Buyuluk.M));
            INPROGRESS.Add(new Kart("Temizlik", "Camlari Sil", "İpek Tunç",Kart.Buyuluk.S));
            DONE.Add(new Kart("Spor", "2 Km Kos", "Erhan Büyük",Kart.Buyuluk.L));
            DONE.Add(new Kart("Ev", "Alisveris Yap", "Mert Tuna",Kart.Buyuluk.XL));
            INPROGRESS.Add(new Kart("Temizlik", "Toz Al","Dilan Söz",Kart.Buyuluk.XS));
        }
